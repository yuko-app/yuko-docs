...
```bash cURL
curl --request GET \
  --url "https://api.yukoapp.com/api/v1/public/customers/9049402769586/tiers" \
...
const response = await fetch(
  `https://api.yukoapp.com/api/v1/public/customers/${customerId}/tiers`,
  {
    method: "GET",
    headers: {
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.yukoapp.com/api/v1/public/customers/{$customerId}/tiers");
