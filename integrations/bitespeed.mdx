...
<Note>
**Where to find this:** Shopify admin → Apps → Yuko Loyalty → Account Settings → Integrations → BiteSpeed
</Note>
...
<Steps>
  ...
  <Step title="Open BiteSpeed in Yuko">
    In Shopify admin, go to **Apps → Yuko Loyalty → Account Settings → Integrations**, pick the **WhatsApp** category, and click **BiteSpeed**.
  </Step>
