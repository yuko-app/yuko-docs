...
<Note>
**Where to find this:** Shopify admin → Apps → Yuko Loyalty → Account Settings → Integrations → AskEva
</Note>
...
<Steps>
  ...
  <Step title="Open AskEva in Yuko">
    In Shopify admin, go to **Apps → Yuko Loyalty → Account Settings → Integrations**, pick the **WhatsApp** category, and click **AskEva**.
  </Step>
