...
<Note>
**Where to find this:** Shopify admin → Apps → Yuko Loyalty → Account Settings → Integrations → Judge.me
</Note>
...
<Steps>
  ...
  <Step title="Open Judge.me in Yuko">
    In Shopify admin, go to **Apps → Yuko Loyalty → Account Settings → Integrations**, and click **Judge.me**.
  </Step>
