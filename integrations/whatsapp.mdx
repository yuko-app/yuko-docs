...
<Steps>
  ...
  <Step title="Open the provider integration in Yuko">
    In Shopify admin, go to **Apps → Yuko Loyalty → Integrations**, pick the **WhatsApp** category from the left sidebar, and click your provider's tile (e.g., **AISensy**, **WATI**, **Zoko**).
  </Step>
