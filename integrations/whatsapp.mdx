---
title: WhatsApp
description: Send transactional loyalty messages via WhatsApp Business API through any of 7 supported platforms. Wired into Workflows for points-earned, reward-redeemed, tier-changed and other loyalty events.
---
...
But WhatsApp Business API is a closed ecosystem. You can't send messages directly; you have to go through a Business Solution Provider (BSP). Yuko connects to 7 BSPs so you can use whichever one you already have a contract with.
...
<Check>You have an active WhatsApp Business API account with one of the 7 supported providers.</Check>
