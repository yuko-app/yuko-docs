...
- Encourage photo and video reviews with visual content
...
Yuko Dashboard → **Reviews → Settings**
...
<CardGroup cols={2}>
  <Card title="Email Review Requests" icon="envelope">
    **Most effective method**
    ...
    - Customers get direct link to form
    - 5-10% response rate
  ...
  <Card title="On-Site Review Forms" icon="browser">
    **Always available option**
    ...
    - Customers can review anytime
    - 1-2% organic reviews

    → [Add review collection form](/collect-reviews/review-collection-form)
  </Card>

  <Card title="Shop/Site Reviews" icon="store">
    **Overall experience feedback**

    - Not tied to specific product
    - General testimonials
    - Homepage/footer placement
    - Trust badges

    → [Enable shop reviews](/collect-reviews/collecting-shop-site-review)
  </Card>

  <Card title="Custom Review Inputs" icon="sliders">
    **Tailored questions**
    ...
    → [Customize review fields](/collect-reviews/customizing-review-inputs)
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Shop/Site Reviews (Testimonials)" icon="building-columns">
  ...
  <Accordion title="Photo & Video Reviews" icon="camera">
...
<Tabs>
  <Tab title="Starting Out">
    ...
    **Setup:**
    ...
    2. ✅ Set up review request emails (7 days after delivery)
...
<CardGroup cols={2}>
  ...
  <Card title="Show Examples" icon="lightbulb">
    **Guide customers on what to write**

    - Display sample reviews
    - Suggest review topics
    - Show photo examples
    - Explain helpful reviews

    **Result:** 40% longer, more detailed reviews
  </Card>
...
<AccordionGroup>
  ...
  <Accordion title="Should I collect customer photos and videos?" icon="camera-movie">
...
<Steps titleSize="h3">
  <Step title="Add Review Form to Product Pages" icon="browser">
    ...
    **Time:** 10 minutes
    → [Review Collection Form Setup](/collect-reviews/review-collection-form)
  </Step>

  <Step title="Set Up Review Request Emails" icon="envelope">
    Automatically ask customers for reviews 7 days after their order is delivered.
  ...
  <Step title="Enable Shop Reviews (Optional)" icon="store">
    ...
    **Time:** 5 minutes
    → [Shop Review Setup](/collect-reviews/collecting-shop-site-review)
  </Step>
</Steps>
