...
<Note>
**Where to find this:** Shopify App Store → search “Yuko” → Install
</Note>
...
<Steps>
  <Step title="Open the Yuko listing">
    Search for **Yuko** on the [Shopify App Store](https://apps.shopify.com) and click **Install**.
  </Step>
  ...
  <Step title="Complete onboarding">
    Set your points label, currency and starter campaigns. You can change all of this later in **Loyalty → Settings**.
  </Step>
</Steps>
...
- Custom storefronts (Hydrogen, headless) need extra integration work — see the [Webhooks](/loyalty/overview) and API Reference documentation.
...
<Tip>**Bookmark the dashboard**. The Yuko dashboard is at [app.yukoapp.com](https://app.yukoapp.com) and is also accessible from the Shopify admin sidebar.</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="Can I install on multiple stores?">
    Yes. Each store gets its own Yuko organisation and billing. Multi-store accounts can share members and reporting — see [Organization & multi-store](/loyalty/overview).
  </Accordion>
