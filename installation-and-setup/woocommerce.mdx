...
<Steps>
  ...
  <Step title="Download the Yuko Plugin" icon="download">
    ...
    **How to download:**
    ...
    > Once activated, the plugin connects your store with Yuko.
  ...
  <Step title="Connect Your Store to Yuko" icon="link">
    ...
    **How to connect:**\
    \
    Return to your **Yuko Dashboard** (in the other browser tab)
...
<AccordionGroup>
  <Accordion title="Plugin activated but Yuko not showing in sidebar" icon="triangle-exclamation">
    ...
    **Still not working?** Contact [support@yuko.so](mailto:support@yuko.so) with:
  ...
  <Accordion title="Email verification link not working" icon="envelope-open-text">
    ...
    **Still can't verify?**
    ...
    - Email [support@yuko.so](mailto:support@yuko.so) from the email address you used
