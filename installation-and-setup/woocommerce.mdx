...
<Steps titleSize="h3">
  <Step title="Configure Review Request Emails" icon="envelope">
    ...
    **Time:** 10 minutes
    ...
    → [Set Up Review Requests](/request-reviews/reviewRequestEmails)
  </Step>
  ...
  <Step title="Add Review Display to Product Pages" icon="star">
    ...
    **Time:** 5 minutes
    ...
    → [Product Page Reviews](/display-reviews/productReviewsDisplayWidget)
  </Step>
  ...
  <Step title="Choose Review Approval Settings" icon="shield-check">
    ...
    **Time:** 3 minutes
    ...
    → [Review Approval Settings](/managing-reviews/autoPublishingReviews)
  </Step>
...
<Note>
**Pro tip:** After installation, immediately set up review request emails so you don't miss any orders. Go to [Review Request Setup](/request-reviews/reviewRequestEmails) next.
</Note>
