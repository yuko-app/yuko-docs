...
```bash cURL
curl --request POST \
  --url "https://api.yukoapp.com/v1/public/customers/9049402769586/transactions" \
...
const response = await fetch(
  `https://api.yukoapp.com/v1/public/customers/${customerId}/transactions`,
  {
    method: "POST",
    headers: {
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.yukoapp.com/v1/public/customers/{$customerId}/transactions");
