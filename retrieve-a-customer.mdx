...
```bash cURL
curl --request GET \
  --url "https://api.yukoapp.com/api/v1/public/customers/retrieve?customer_id=9049402769586" \
...
const response = await fetch(
  `https://api.yukoapp.com/api/v1/public/customers/retrieve?customer_id=${customerId}`,
  {
    method: "GET",
    headers: {
