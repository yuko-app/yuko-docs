...
```bash cURL
curl --request GET \
  --url "https://api.yukoapp.com/api/v1/public/customers/9049402769586/transactions?entry_type=credit&per_page=20" \
...
const response = await fetch(
  `https://api.yukoapp.com/api/v1/public/customers/${customerId}/transactions?${params}`,
  {
    method: "GET",
    headers: {
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.yukoapp.com/api/v1/public/customers/{$customerId}/transactions?{$query}");
