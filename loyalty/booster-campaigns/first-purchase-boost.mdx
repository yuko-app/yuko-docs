...
The First Purchase Boost rewards a specific moment, so the storefront's job is to make sure non-customers see it everywhere they look:
...
- **Day 0 (signup)** — welcome email mentioning the boost
