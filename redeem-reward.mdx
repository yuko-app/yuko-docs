...
```bash cURL
curl --request POST \
  --url "https://api.yukoapp.com/api/v1/public/rewards/redeem" \
...
const response = await fetch(
  "https://api.yukoapp.com/api/v1/public/rewards/redeem",
  {
    method: "POST",
    headers: {
...
```php PHP
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.yukoapp.com/api/v1/public/rewards/redeem");
