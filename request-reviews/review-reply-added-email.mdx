...
<AccordionGroup>
  ...
  <Accordion title="Subject Line: Make it Personal" icon="envelope">
    **Setting:** Email Subject
    ...
    - _We replied to your review on {{review_product_name}}_
    - _Thanks for your feedback on {{review_product_name}}_
  ...
  <Accordion title="Message (Body)">
    ...
    - **{{review_product_image}}** – Show the product image
    - **{{review_product_url}}** – Link to the product page
  ...
  <Accordion title="Unsubscribe Text & Description">
    ### Why this matters
