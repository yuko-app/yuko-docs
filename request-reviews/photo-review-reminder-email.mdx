...
<Steps>
  ...
  <Step title="Reminder Waits" icon="clock">
    Yuko waits your set delay (default: 5 days after review submission).
...
<AccordionGroup>
  <Accordion title="Timing: When to Send Reminder" icon="clock" defaultOpen>
    **Setting:** Delay (days)
...
<AccordionGroup>
  ...
  <Accordion title="Should I approve photos before they appear?" icon="shield-check">
    ...
    **Best for:** Fashion/beauty (where photos might be revealing), new stores, products where wrong photos could confuse (tech products)
    ...
    <Tip>
    **Start with auto-publish:** You can always switch to manual approval if you see issues. But most stores never have problems with inappropriate photos (<1% of submissions).
    </Tip>
  </Accordion>
...
<Steps titleSize="h3">
  <Step title="Decide on Incentive" icon="gift">
    ...
    **Recommendation:** Start with no incentive (works for 15-20% of customers)
    **Location:** Reviews → Emails → Photo Review Reminder Email
  </Step>
  ...
  <Step title="Write Appreciative Message" icon="pen">
    ...
    **Time:** 3 minutes
    **Tone:** Thankful first, then gentle request
  </Step>
  ...
  <Step title="Enable & Monitor" icon="chart-line">
    ...
    **Expected:** 15-25% of text-only reviewers add photos when reminded
    **Monitor:** After 30 days, check photo review percentage increase
  </Step>
</Steps>
